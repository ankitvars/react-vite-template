...
export const SkeletonSaleListView: React.FC<{ count?: number }> = ({ count = 6 }) => (
  <Stack className="listRoot">
    {/* Header */}
    <Stack direction="row" className="listHeader">
      <Stack className="listProject"><Skeleton width={80} /></Stack>
      <Stack className="listChain"><Skeleton width={80} /></Stack>
      <Stack className="listSaleType"><Skeleton width={80} /></Stack>
      <Stack className="listStatus"><Skeleton width={80} /></Stack>
      <Stack className="listProgress"><Skeleton width={80} /></Stack>
    </Stack>
    {/* Skeleton rows */}
      ...
      <Paper key={idx} elevation={0} className="listPaper">
        <Stack direction="row" className="listRow" alignItems="center">
          ...
          <Stack className="listProgress" sx={{ minWidth: 180, maxWidth: 180 }}>
            <Skeleton variant="rectangular" height={8} width="100%" sx={{ borderRadius: 4, mb: 1 }} />
